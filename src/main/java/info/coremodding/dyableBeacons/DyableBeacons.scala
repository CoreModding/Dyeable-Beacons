...
object DyableBeacons {
  ...
  val dyableBeaconNames = Array("White Beacon", "Orange Beacon", "Magenta Beacon", "Light Blue Beacon", "Yellow Beacon", "Light Green Beacon", "Pink Beacon", "Dark Grey Beacon", "Light Grey Beacon", "Cyan Beacon", "Purple Beacon", "Blue Beacon", "Brown Beacon", "Green Beacon", "Red Beacon", "Black Beacon")
  ...
  var dyableBeacon: Block = new BlockDyableBeacon().setBlockName("dyableBeacon").setLightLevel(1.0F).setBlockTextureName("beacon")
